...
if(isset($_SESSION['id'])&& $_SESSION['klasif']==2){
    ...
    and data_pinjaman.id_ebook=data_ebook.id_ebook and data_ebook.id_kategori=kategori_ebook.id_kategori 
    and data_pinjaman.id_user='$user'and data_pinjaman.end_pinjam>NOW()";
