                        ...
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">SMA Mekar Arum</h3>
                                </div>
                                <div class="card-header">
                                    <h5 class="text-center font-weight-light my-4">Digital Library</h5>
                                </div>
                                <div class="card-body">
                                ...
                                <div class="card-footer text-center py-3">
                                    <div class="d-grid"><a href="register.php">Need an account? Sign up!</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
