    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div class="row justify-content-center">
                            <div class="col-lg-7">
                            <div class="card-header"><h3 class="text-center font-weight-light my-4">Edit Profil</h3></div>
                                    <div class="card-body">
                                        <form action="" method="post">
                                            ...
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid"><button class="btn btn-primary btn-block" type="submit" name="edit"
                                                    >Edit Profil</button></div>
                                            </div>
                                        </form>
                                    </div>
                                </div>
